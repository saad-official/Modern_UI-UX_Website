...
const InsightCard = ({ title, subtitle, imgUrl, index }) => (
  <motion.div
    variants={fadeIn('up', 'spting', index * 0.5, 1)}
  ...
  >
    ...
    <div className="w-full flex justify-between items-center">
      ...
      <div className="lg:flex hidden items-center justify-center w-[100px] h-[100px] rounded-full bg-transparent border border-white cursor-pointer hover:bg-gray-400">
