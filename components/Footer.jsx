  ...
  >
    ...
    <div className={`${styles.innerWidth} mx-auto flex flex-col gap-8`}>
      <div className="flex items-center justify-between flex-wrap gap-5">
        ...
        <button type="button" className="flex items-center h-fit py-4 gap-2 px-6 bg-[#25618b] rounded-[32px]">
          <img src="/headset.svg" className="w-[24px] h-[24px] object-contain" alt="" />
